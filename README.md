...
| :---: | :---: | :---: |
| `method` | `euler`, `rk2`, `rk3`, `rk4`, `rk56` | `rk4` |
...
| `t_end` | Время моделирования (дни) | `double > 0` | `1000.0` |
...
| `alpha` | Показатель вакцинации  | `0 <= double <= 1` | `0.0015` |
| `beta` | Коэффициент заражения | `0 <= double <= 1` | `0.25` |
| `gamma` | Уровень выздоровления | `0 <= double <= 1` | `0.10` |
| `delta` | Показатель смертности | `0 <= double <= 1` | `0.0005` |
| `sigma` | Коэффициент восприимчивости | `0 <= double <= 1` | `0.005` |
...
| Ключ | Описание | Тип | Значение по умолчанию |
| :---: | :---: | :---: | :---: |
| `i0` | Начальное число зараженных | `0 <= double <= N` | `10.0` |
| `r0` | Начальное число выздоровевших  | `0 <= double <= N` | `0.0` |
| `v0` | Начальное число вакцинированных | `0 <= double <= N` | `0.0` |
| `d0` | Начальное число умерших | `0 <= double <= N` | `0.0` |
...
| Ключ | Описание | Тип | Значение по умолчанию |
| :---: | :---: | :---: | :---: |
| `out` / `output` / `output_file` | Имя выходного **CSV-файла** | `string` | `output.csv` |
