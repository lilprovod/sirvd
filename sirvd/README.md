...
| `alpha` | Показатель вакцинации  | `0 <= double <= 1` | `0.0005` |
| `beta` | Коэффициент заражения | `0 <= double <= 1` | `0.4` |
| `gamma` | Уровень выздоровления | `0 <= double <= 1` | `0.1` |
| `delta` | Показатель смертности | `0 <= double <= 1` | `0.002` |
| `sigma` | Коэффициент восприимчивости | `0 <= double <= 1` | `0.2` |
